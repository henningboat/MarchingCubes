...
namespace Code.CubeMarching.StateHashing
{
    ...
    {
        private readonly BufferFromEntity<CSubGraphGeometryInstruction> _getTerrainInstructions;
        ...
        {
            _getTerrainInstructions = systemBase.GetBufferFromEntity<CSubGraphGeometryInstruction>(true);
